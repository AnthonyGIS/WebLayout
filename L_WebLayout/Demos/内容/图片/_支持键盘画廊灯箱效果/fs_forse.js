(function (d, m, g) {
    ...
    function p(a, c) {
        var d = ["-webkit-", "-moz-", "-o-", "-ms-", ""], b = {}, f, e = d.length;
        for (f = 0; f < e; f++) b[d[f] + a] = c;
        return b
    }

    function u(a) {
        return css3 ? p("transform", "translate(" + a + "px, 0)") : {left: a}
    }

    var h = 0, v = function (a, c, d) {
        function b(b, a) {
            for (var c in b)
        ...
        function f(a, c, f) {
            var e = a.charAt(0).toUpperCase() + a.substr(1), g = (a + " " + m.join(e + " ") + e).split(" ");
            if ("string" === typeof c || "undefined" === typeof c) c = b(g, c); else a:{
        ...
        a = {};
        var e = c.createElement("modernizr"), g = e.style, m = ["Webkit", "Moz", "O", "ms"],
            l = ["webkit", "moz", "o", "ms"], e = {}, n = [], r = n.slice, q, h = {}.hasOwnProperty, k;
        ...
        Function.prototype.bind || (Function.prototype.bind = function (b) {
            ...
            var c = r.call(arguments, 1), d = function () {
                if (this instanceof d) {
                    ...
                    var l = new l, e = a.apply(l, c.concat(r.call(arguments)));
    ...
    k.prototype = {
        constructor: k, createArray: function () {
            var a = this;
            a.images = [];
            a.e.parent("a").length ? a.e.parent("a").each(function () {
                a.images.push({src: this.href, alt: d(this).find("img")[0].alt})
            }) : a.e.each(function () {
                a.images.push({src: this.src, alt: this.alt})
            })
        }, createHtml: function () {
            ...
            d("<img>", {src: this.images[a].src, alt: this.images[a].alt}).on("load", function () {
                c(a, d(this))
            })
        }, events: function () {
            function a(a) {
            ...
            var b = this, f = 0, e = !1, k, p = b.o.duration;
            b.pos = 0;
            ...
            d(g).resize(function () {
                ...
                var a = b.images[b.i], a = t(a.width, a.height, b.w, b.h);
                b.shuft.find("div").css({width: b.w, height: b.h}).find("img").css({
                    width: a.width,
                    height: a.height,
            ...
            var c = this, d = c.shuft.children("div").eq(a);
            d.data().loaded || (d.data({loaded: !0}), c.loadImg(a, function (a, f) {
    ...
    d.fn.fsgallery.defaults = {duration: 500, loop: !1, preload: 2, fadeTime: 1E3}
